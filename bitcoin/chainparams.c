...
const struct chainparams networks[] = {
    ...
    {.network_name = "viacoin",
     .bip173_name = "via",
     .bip70_name = "main",
     .genesis_blockhash = {{{.u.u8 = {0xa1, 0x0b, 0x40, 0x9a, 0x53, 0xa1, 0x1d, 
                          0x97, 0x79, 0x0d, 0x97, 0x70, 0x5a, 0xe3, 0xab, 0xea,
                          0x15, 0x15, 0x33, 0xc0, 0x8e, 0x12, 0x30, 0x98, 0x04,
                          0x76, 0x99, 0x1f, 0x00, 0x54, 0x9b, 0x4e }}}},
     .rpc_port = 5222,
     .cli = "viacoin-cli",
     .cli_args = NULL,
     .cli_min_supported_version = 150000,
    ...
    {.network_name = "viacoin-testnet",
     ...
     .genesis_blockhash = {{{.u.u8 = { 0xa0, 0x29, 0x3e, 0x4e, 0xeb, 0x3d, 0xa6,
                           0xe6, 0xf5, 0x6f, 0x81, 0xed, 0x59, 0x5f, 0x57, 0x88,
                           0x0d, 0x1a, 0x21, 0x56, 0x9e, 0x13, 0xee, 0xfd, 0xd9,
                           0x51, 0x28, 0x4b, 0x5a, 0x62, 0x66, 0x49 }}}},
     .rpc_port = 25222,
     .cli = "viacoin-cli",
     .cli_args = "-testnet",
     .cli_min_supported_version = 150000,
